...
Despite all financial metrics and inputs for sentimental analysis staying consistent, the output generated by Bard differed as it once suggested to invest in a particular company and other times it said that it would not be a good investment. This can lead to distrust in the output we received and we will not be able to recommend the correct investment plans to our end users if we solely depended on these outputs. 

Detailed comparison report is available at - https://docs.google.com/spreadsheets/d/1iXdC1Ljh9hPXsbDkATPNWLgwRre-xjStr9pDlMaQorE/edit#gid=1593249505
